...
#' packages will remain on the bucket but not on local storage. When respawning and environment, then sync_packages function can be run and
#' all packages from the bucket will sync to the local storage saving time it takes to download and re-install R packages.
#' @export
